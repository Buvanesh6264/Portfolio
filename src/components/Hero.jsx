        ...
        <div className="hero-content">
          <div className="hero-text">
            ...
            <div className="hero-socials">
              <a href="https://www.linkedin.com/in/buvanesh-m-3a976b212" target="_blank" rel="noopener noreferrer">
                <FaLinkedin />
              </a>
              <a href="https://github.com/Buvanesh6264" target="_blank" rel="noopener noreferrer">
                <FaGithub />
              </a>
            </div>
          </div>
